 ...
 * Implementing class is invoked from Lenny during a test run.
 * 
 * @author SK Skytteren
 */
public interface ICustomTestStep {
	 ...
	 * See the Lenny documentation for examples of how to use the CubicWait class.
	 * 
	 * We expect you to use JUnit type assertions like assertEquals. 
	 * In this way Lenny can handle the CustomTestStep assertion failures correctly.
	 ...
	 * 
	 * @param arguments (key-value pairs) Key names are from Custom Step definition and values from properties page in Lenny.
	 ...
	 * @throws any type of exception or error. Handled by Lenny. java.lang.AssertionError = test failed, others = test exception.
	 */
